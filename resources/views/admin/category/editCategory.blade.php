...
{{--                    <div class="card-header text-center">{{ __('Edit Category') }}</div>--}}
                        <div class="card-body">
                            {!! Form::open(['route'=>'/catUpdate','method'=>'POST','class'=>'form-horizontal','name'=>'editCategoryForm'])!!}
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-4 col-form-label text-md-right">Category Title</label>
                                    <div class="col-md-8">
                                        <input type="text" value="{{$categoryById->categoryTitle}}" class="form-control" name="categoryTitle">
