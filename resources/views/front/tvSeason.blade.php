                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tabs_i2-pane1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs1-8 col-xs-12">
                                <a href="{{url('/subCatTvEpisode/'.$product->id)}}"
                                    ...
                                    <span class="hoverBorderWrapper">
                                        ...
                                        <img src="{{asset($product->seasonFile)}}"
                                ...
                                <div class="post-details" style="line-height:1.2em;margin-bottom:15px;">
                                    <p class="MovieTitle">
                                        <a href="{{url('/subCatTvEpisode/'.$product->id)}}"
                                            title="Super Over"></a>
                                        <a href="{{url('/subCatTvEpisode/'.$product->id)}}" title="Super Over"
                                ...
                                <div class="displayHover1 BoxCss" id="" style=""
                                    ...
                                    <div class="col-md-2"
                                        style="margin-top: 10px;border: 1px solid #000;border-radius: 50px;height: 50px;width: 50px;">
                                        <div
                                            style="text-align:center;font-size:14px;font-weight: bold;margin-top: 5px;margin-left: -3px;">
                                            111</div>
                                        <div style="margin-top: -10px;margin-left: -2px;">min</div>
                                    </div>
                                    <div class="col-md-12"
