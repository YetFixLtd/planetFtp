	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<div style="margin-top:77px;">
				...
				<video id="video-id">
					<source src="{{$children->productUrl}}" type='video/mp4'>
					<source src="{{$children->productUrl}}" type='video/webm'>
				</video>
				{{-- @endforeach --}}
				<script>
						...
						<div class="tabbable tabs_style2">
							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="Details">
									<h3>Details</h3>
									<p>{{$children->productDescription}}</p>
								</div>
							</div>
							<!--/ Tabs content -->
						</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<div class="tabbable tabs_style5">
					...
					<ul class="nav fixclear">
						<!-- Tab #1 -->
						<li class="active"><a href="#tabs_i2-pane1" data-toggle="tab">Related Movies</a></li>
						<!--/ Tab #1 -->
					</ul>
					<!--/ Navigation menu -->
