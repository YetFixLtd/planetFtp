            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="tabbable tabs_style5">
                    ...
                    <ul class="nav fixclear">
                        <!-- Tab #1 -->
                        <li class="active"><a href="#tabs_i2-pane1" data-toggle="tab">Recent Hindi Movies Uploads</a></li>
                        <!--/ Tab #1 -->
                    </ul>
                    <!--/ Navigation menu -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tabs_i2-pane1">
                            ...
                            ->where('products.SubCategoryId', 2)
                            ->paginate(8);
                            // ->get();
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs1-8 col-xs-12">
                                <a href="{{url('/movie/'.$product->id)}}"
                                    ...
                                    <span class="hoverBorderWrapper">
                                        ...
                                        <img src="{{asset($product->productFile)}}"
                                            onerror="this.src='http://image.tmdb.org/t/p/w500/4U1SBHmwHkNA0eHZ2n1CuiC1K1g.jpg"
                                ...
                                <div class="displayHover1 BoxCss" id="{{$product->id}}" style=""
                                    ...
                                    <div class="col-md-12" style="font-size: 16px;font-weight: bold;margin-top: 8px;line-height: 15px;">{{$product->productTitle}}</div>
                                    <div class="col-md-12" style="line-height: 13px;margin-top: 10px;">{{$product->productDescription}}<a href="">More</a>. <br>
