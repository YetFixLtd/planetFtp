                    ...
                    <div id="kl-store_product_categories-2 sidebar-widget" class="widget widget_product_categories">
                        ...
                        <ul class="product-categories">
                            @foreach ($all_sub_categories as $sc)
                                ...
                                <li class="cat-item"><a href="{{ route('/subCatProductRoute', ['id' => $sc->id]) }}"> <i
                                            class="far fa-folder-open"></i> {{ $sc->subCategoryTitle }}</a><span
                                        class="count">&nbsp;({{ $product_count_by_subcat }})</span>
                                    ...
                                    <ul class="children">
                                        @foreach ($product_years as $year)
                                            ...
                                            @endphp
                                            <li class="cat-item"><a
                                                    href="{{ url('sub-category-year/' . $year->SubCategoryId . '/' . $year->year) }}">
                                                    <i class="far fa-folder-open"></i> {{ $year->year }}</a><span
                                                    class="count">&nbsp;({{ $product_count_by_year }})</span> </li>
                                        @endforeach
                                    </ul>
                                </li>
                            @endforeach
                            ...
                            <div class="tab-pane active" id="tabs_i2-pane1">
                                ...
                                @foreach ($children as $product)
                                    <div class="col-lg-2 col-md-4 col-sm-6 col-xs1-8 col-xs-12">
                                        <a href="{{ url('/movie/' . $product->id) }}" class="thumb hoverBorder plus boxHov1"
                                        ...
                                        <div class="post-details" style="line-height:1.2em;margin-bottom:15px;">
                                            <p class="MovieTitle">
                                                ...
                                                <a href="{{ url('/movie/' . $product->id) }}" title="Super Over"
                                        ...
                                        <div class="displayHover1 BoxCss" id="{{ $product->id }}" style=""
                                            ...
                                            <div class="headBox">
                                                <ul>
                                                    ...
                                                    <li style="margin-left: 20px;margin-top: 6px;"><a href="#"
                                                            class="flove" title="add to favourite list"><span
                                            ...
                                            <div class="col-md-9" style="clear:left;background:-color:#fff;">
                                                ...
                                                <div style="font-size: 10px;"><a
                                                        href="allmovies98bc.html?page=1&amp;entries=24&amp;Category=South%20Indian&amp;Genre=Drama&amp;sort=DESC&amp;w=grid">Drama</a>
                                                    ,<a
                                                        href="allmovies0586.html?page=1&amp;entries=24&amp;Category=South%20Indian&amp;Genre=Thriller&amp;sort=DESC&amp;w=grid">Thriller</a>,
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" style="line-height: 13px;margin-top: 10px;">
                                                {{ $product->productDescription }}<a
                                                    href="moviec503.html?imdbid=tt13841394&amp;cat=South%20Indian">More</a>.
                                                <br>
                                                <a class="btn-element btn btn-fullcolor btn-sm " href=""
                                                    data-lightbox="iframe" title="Watch Trailer"
                                                    style="margin:5px 5px 5px 0;"><span><i
                                                ...
                                                <a class="btn-element btn btn-lined lined-dark btn-sm "
                                                    href="moviec503.html?imdbid=tt13841394&amp;cat=South%20Indian"
