                ...
                <div class="tabbable tabs_style5">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tabs_i2-pane1">
                            ...
                            {{-- @dd($product->tvSeriesFile) --}}
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs1-8 col-xs-12">

                                <img src="{{asset($product->tvSeriesFile) }}" style="height:200px;width:160px;">

                                <a href="{{url('/subCatTvSeason/'.$product->id)}}"
                                    ...
                                    <span class="hoverBorderWrapper">
                                         ...
                                         <img src="{{($product->tvSeriesFile) }}"
                                             class="img-responsive offer-banners-img" alt="" title="{{ ($product->id) }}"
                                ...
                                <div class="post-details" style="line-height:1.2em;margin-bottom:15px;">
                                    <p class="MovieTitle">
                                        <a href="{{url('/subCatTvSeason/'.$product->id)}}"
                                            title="Super Over"></a>
                                        <a href="{{url('/subCatTvSeason/'.$product->id)}}" title="Super Over"
                                            style="padding: 1px 4px;font-size: 11px;margin-right: 6%;float:right;">
                                            <span>{{ $product->tvSeriesTitle }}</span>
